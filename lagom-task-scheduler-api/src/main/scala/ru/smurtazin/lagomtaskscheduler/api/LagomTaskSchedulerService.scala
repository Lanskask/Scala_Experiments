package ru.smurtazin.lagomtaskscheduler.api
...
object LagomTaskSchedulerService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The Lagom Task Scheduler service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomTaskSchedulerService.
  */
trait LagomTaskSchedulerService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("lagom-task-scheduler")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LagomTaskSchedulerService.TOPIC_NAME, greetingsTopic _)
